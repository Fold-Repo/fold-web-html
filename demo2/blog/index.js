const blogPosts = [
  {
    ...
    description:
      "Details about the product in question goes here. You have the option to now select and buy. Details about the product in question goes here. You have the option to now select and buy.Details about the product in question goes here. You have the option to now select and buy...Read more",
    image2: "../../assets/images/blog-mini.svg",
    paragraph1: `Lorem ipsum dolor sit amet consectetur. Maecenas mus id nunc facilisi. Justo nulla suscipit quis dictum dui massa at consectetur. Augue purus commodo feugiat enim id aliquam libero amet imperdiet. Ac amet nec tortor turpis interdum diam. Tortor viverra mattis euismod consectetur sed. Sodales blandit id id faucibus odio magna in. Pulvinar mauris risus sollicitudin velit faucibus venenatis. Egestas imperdiet massa orci ac in elit tellus ac sed. Et et diam enim euismod ipsum. 

        Tortor orci donec mauris egestas sem purus dignissim cursus. Orci justo penatibus malesuada vitae ultricies eget. Vestibulum in ullamcorper blandit eu ultricies. Scelerisque tellus leo tristique amet. Nibh facilisis nisl lacus hac sed volutpat arcu risus. Sed in amet enim aenean fermentum vitae lorem in. Urna non lectus risus nunc commodo purus tellus. Ultricies commodo sit nibh donec pellentesque. Quis aliquet nibh porttitor bibendum velit nisl nisi ornare augue. Id aliquam elit penatibus tortor.
  ...
  },
  {
    ...
    description:
      "Details about the product in question goes here. You have the option to now select and buy...Read more",
    image2: "../../assets/images/blog-mini.svg",
    paragraph1: `Lorem ipsum dolor sit amet consectetur. Maecenas mus id nunc facilisi. Justo nulla suscipit quis dictum dui massa at consectetur. Augue purus commodo feugiat enim id aliquam libero amet imperdiet. Ac amet nec tortor turpis interdum diam. Tortor viverra mattis euismod consectetur sed. Sodales blandit id id faucibus odio magna in. Pulvinar mauris risus sollicitudin velit faucibus venenatis. Egestas imperdiet massa orci ac in elit tellus ac sed. Et et diam enim euismod ipsum. 
  ...
  {
    id: 6,
    title: "Tech Influencer Strategies",
  ...
  {
    id: 7,
    title: "Cinematic Video Techniques",
  ...
  {
    id: 8,
    title: "Urban Photography Styles",
...
let mainBlogs = blogPosts.filter((_, index) => index % 3 === 0);
let sideBlogs = blogPosts.filter((_, index) => index % 3 !== 0);

blogContainer.innerHTML = mainBlogs
  .map(
    (mainBlog, i) => `
<div class="md:col-span-2 cursor-pointer">
    <img src="${mainBlog.image}" alt="${
      mainBlog.title
    }" class="w-full rounded-lg">
    <h3 class="text-base font-medium mt-2">${mainBlog.title}</h3>
    <p class="text-[#4B5563] text-sm">${
      mainBlog.description
    } <span onclick="navigateToDetails(${
      mainBlog.id
    })"  class="text-[#0EA5E9] text-[#0EA5E9] cursor-pointer">Read more</span></p>
</div>
<div class="space-y-6">
    ${sideBlogs
      .slice(i * 2, i * 2 + 2)
      .map(
        ...
        <div class="cursor-pointer">
            ...
            <h3 class="text-base font-medium mt-2">${post.title}</h3>
            <p class="text-gray-600 text-sm">${post.description} <span onclick="navigateToDetails(${post.id})" class="text-[#0EA5E9]  cursor-pointer">Read more</span></p>
        </div>
    `
      )
      .join("")}
...
function navigateToDetails(id) {
  localStorage.setItem(
    "selectedBlog",
    JSON.stringify(blogPosts.find((post) => post.id === id))
  );
  window.location.href = "/demo2/blog/details.html";
}
...
if (selectedBlog) {
  ...
  document.getElementById("blog-content").textContent = selectedBlog.content;
} else {
